                    ...
                    <Grid className="home-grid">
                        ...
                        <Cell col={12} align='middle'>
                            ...
                            <Grid className="skill-grid">
                                ...
                                <Cell col={3} phone={12}>
                                    <Card shadow={0} style={{width: '100%', margin: 'auto'}}>
                                                <CardTitle style={{color: '#fff', height: '10vh', 
                            ...
                            <hr/>
                            <Grid className="skill-grid">
                                <Cell hidePhone col={3} align='middle'><img src={'./industrial-robot.png'} alt='robot_logo' className='skill-ico'></img></Cell>
                                <Cell hidePhone col={3} align='middle'><img src={'./machinery.png'} alt='machinery_logo' className='skill-ico'></img></Cell>
                                <Cell hidePhone col={3} align='middle'><img src={'./cogwheel.png'} alt='cogwheel_logo' className='skill-ico'></img></Cell>
                                <Cell hidePhone col={3} align='middle'><img src={'./automation.png'} alt='automation_logo' className='skill-ico'></img></Cell>
                            </Grid>
                        </div>
                        </Cell>
                    </Grid>
