...
import { Grid, Chip, Cell, Card, CardTitle, CardText, Button, IconButton, CardMenu } from 'react-mdl';
                    ...
                    <Grid className="resume-grid">
                                ...
                                <CardTitle style={{color: '#fff', height: '3em', 
                                    ...
                                    <Grid style={{width: '100%'}}>
                                        <Cell col={2} hidePhone={true} style={{margin: 'auto', 'text-align': 'center', 'min-width':'2em'}}>
                                            <img src={'/ibm.png'} alt='IBM' className='ico-resume-cert'></img>
                                        </Cell>
                                        <Cell col={10}>
                                        ...
                                        <Cell col={2} hidePhone={true} style={{margin: 'auto', 'text-align': 'center', 'min-width':'2em'}}>
                                            <img src={'/google.png'} alt='Google' className='ico-resume-cert'></img>
                                        </Cell>
                                        <Cell col={10}>
                            ...
                            <Card shadow={0} style={{width: '100%'}} id='resume-entry'>
                                ...
                                <CardText>
                                    <table style={{width: '100%', 'padding-left': '1em', 'padding-right': '1em'}}>
                                        ...
                                        <tr><Chip>Python</Chip><Chip>C#</Chip><Chip>VBA</Chip><Chip>C++</Chip><Chip>MATLAB</Chip><Chip>NI LabView</Chip></tr>
                        ...
                        <Cell col={8} phone={12}>
                            <Card shadow={0} style={{width: '100%'}} id='resume-entry'>
                                ...
                                <img src={'/printer.png'} alt='Print' className='ico-print'></img>
                                <div><Button onClick="window.print()" colored>PRINT ME (WIP)
                                </Button></div>
                        </Cell>
                    </Grid>
                    <br></br>
